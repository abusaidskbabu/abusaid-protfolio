...
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Github Link" class=" control-label col-md-4 text-left"> Github Link </label>
										<div class="col-md-6">
										  <input  type='text' name='github_link' id='github_link' value='{{ $row['github_link'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
						...
						<div class="logo-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["logo"],"/uploads/images/setting") !!}
						</div>
						...
						<div class="favicon-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["favicon"],"/uploads/images/setting") !!}
						</div>
