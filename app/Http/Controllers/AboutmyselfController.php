...
class AboutmyselfController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'aboutmyself';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Aboutmyself();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'aboutmyself',
	...
	public static function display(  )
	{
		...
		$model  = new Aboutmyself();
		$info = $model::makeInfo('aboutmyself');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('aboutmyself.public.view',$data);			
			}			
		} 
		else {
			...
			return view('aboutmyself.public.index',$data);	
		}
