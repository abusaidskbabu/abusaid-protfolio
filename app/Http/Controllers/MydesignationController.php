...
use App\Models\Mydesignation;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MydesignationController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'mydesignation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Mydesignation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'mydesignation',
	...
	public static function display(  )
	{
		...
		$model  = new Mydesignation();
		$info = $model::makeInfo('mydesignation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mydesignation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('mydesignation.public.index',$data);	
		}
